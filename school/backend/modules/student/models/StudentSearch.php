...
/**
 * StudentSearch represents the model behind the search form about `backend\modules\student\models\Student`.
 */
class StudentSearch extends Student
{
    ...
    public function rules()
    {
        return [
            ...
            [['school_name', 'student_name', 'sex', 'grade', 'class_name'], 'safe'],
        ];
    }
